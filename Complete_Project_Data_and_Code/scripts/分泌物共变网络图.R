...
exu <- read.csv(file.path(data_derived_dir, "exudate_corrected_matrix.csv"), row.names = 1)
exu_t <- t(exu)
...
write.csv(node_info, file.path(data_derived_dir, "node_attributes_table.csv"), row.names = FALSE)
